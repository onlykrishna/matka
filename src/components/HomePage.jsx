  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      allGames.forEach(g => {
        ...
        if (rDate === todayStr && !marketGroups[title].today) marketGroups[title].today = g;
        if (rDate === yesterdayStr && !marketGroups[title].yesterday) marketGroups[title].yesterday = g;
      });
      ...
      const finalGames = Object.keys(marketGroups).map(title => {
        ...
        displayGame.number1 = group.yesterday?.number2 || 'XX';
